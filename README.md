...
[Code signing](https://github.com/romlingroup/flatpack-ai#code-signing) is vital for FPKs. With compromised or corrupt deployments, you will have a bad day ([Skynet](https://en.wikipedia.org/wiki/Skynet_(Terminator))).
