...
**WARNING:** Running Flatpack outside Docker gives applications unrestricted access to execute Bash and Python code with your user permissions. Docker adds some security, but it does not guarantee safety. Only use Flatpack - inside or outside Docker - if you understand these security risks.
