...
Here is how to create a local flatpack using [RomlinGroup/template](https://github.com/RomlinGroup/template). To make your flatpack public, submit a PR to the [warehouse](https://github.com/RomlinGroup/Flatpack/tree/main/warehouse) (approval is subject to our discretion).
