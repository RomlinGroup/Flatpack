...
Keeping a fork of this repository with the logo is acceptable for GitHub use only, as long as the logo is not used in a way that infringes on the trademark or copyright.