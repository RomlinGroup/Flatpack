...
Flatpack democratises AI/ML with micro language models and model compression. Models range from 10M to 10B parameters and are included in our standardised flatpacks (FPKs) - available soon for edge computing devices, electronic components, and robots, akin to floppy disks or game cartridges for earlier computing eras.
