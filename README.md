...
\* *Training from scratch refers to the pre-training process where models are trained on a large dataset before fine-tuning a specific task. For pre-training, consider it primary education, while fine-tuning is akin to university or college.*
