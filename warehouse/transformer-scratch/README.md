...
Dataset: [english.txt](https://raw.githubusercontent.com/romlingroup/transformer/master/data/english.txt) ([the exclusive property of the European Parliament](https://joint-research-centre.ec.europa.eu/language-technology-resources/dcep-digital-corpus-european-parliament_en#Usage%20Conditions)) forked from the repository https://github.com/bashnick/transformer by Nikolay Bashlykov (please see below for details).
