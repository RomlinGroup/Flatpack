...
sed -i 's/batch_size = 128/batch_size = 96/' finetune/lora.py
sed -i 's/micro_batch_size = 4/micro_batch_size = 2/' finetune/lora.py
python finetune/adapter_v2.py --checkpoint_dir checkpoints/stabilityai/stablelm-base-alpha-3b --precision 32-true
